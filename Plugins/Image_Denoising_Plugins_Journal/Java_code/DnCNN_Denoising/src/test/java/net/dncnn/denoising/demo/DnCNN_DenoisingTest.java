...
import net.dncnn.denoising.demo.DnCNN_Denoising;
...
public class DnCNN_DenoisingTest 
{
	...
	public void runLabelImageCommand() throws ExecutionException, InterruptedException 
		...
		CommandModule module = ij.command().run(DnCNN_Denoising.class, false, "inputImage", img).get();
