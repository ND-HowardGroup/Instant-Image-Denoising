...
l_rate = 1e-3 #lr value is here changed to 1e-3
...
for d in ['/device:CPU:0','/device:GPU:0']:#, '/device:GPU:1', '/device:GPU:2', '/device:GPU:3']:
    with tf.device(d):
        path_save_model = '/afs/crc.nd.edu/user/g/ganantha/Test/Balayya/training_code/Unet_bn/unet_bn_lr1/Saved_model/'
        batch_size = 4
        im_height = 256 #M
        im_width = 256  #N
...
callbacks = [scheduler_callback, csv_logger,
        ModelCheckpointLight('model_multiple_gpus_unet_bn_lr1.h5', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)] #removed early stop
...
def train(epochs):
    ...
    io.savemat('Estimated_result_unet_bn_lr1.mat', dict([('Estimated_result_unet_bn_lr1',test_results)]))
...
if __name__ == "__main__":
    ...
    path_for_images = '/afs/crc.nd.edu/user/g/ganantha/Test/Balayya/training_code/Unet_bn/unet_bn_lr1/plots/'
    path_for_results = '/afs/crc.nd.edu/user/g/ganantha/Test/Balayya/training_code/Unet_bn/unet_bn_lr1/results/'
