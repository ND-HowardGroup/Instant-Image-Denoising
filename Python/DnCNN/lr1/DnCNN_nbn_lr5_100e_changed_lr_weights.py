...
CSV_path = '/afs/crc.nd.edu/user/g/ganantha/Test/Balayya/training_code/lr5_weights/'
...
for d in ['/device:CPU:0','/device:GPU:0']:#, '/device:GPU:1', '/device:GPU:2', '/device:GPU:3']:
    with tf.device(d):
        path_save_model = '/afs/crc.nd.edu/user/g/ganantha/Test/Balayya/training_code/lr5_weights/Saved_model/'
        batch_size = 4
        im_height = 256 #M
        im_width = 256  #N
...
epochs = 100 #this epochs for the lr function adjustment
...
def train(epochs):
    ...
    io.savemat('Estimated_result_c1_lr5_weights.mat', dict([('Estimated_result_c1_lr5_weights',test_results)]))
...
if __name__ == "__main__":
    ...
    path_for_images = '/afs/crc.nd.edu/user/g/ganantha/Test/Balayya/training_code/lr5_weights/plots/'
    path_for_results = '/afs/crc.nd.edu/user/g/ganantha/Test/Balayya/training_code/lr5_weights/results/'
